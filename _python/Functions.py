...
def toggle_Signals(self, opt):
    if not opt:
        ...
        self.ex1General_comboBox.blockSignals(True)
        self.ex2General_comboBox.blockSignals(True)
        ...
        self.ex1General_comboBox.blockSignals(False)
        self.ex2General_comboBox.blockSignals(False)
